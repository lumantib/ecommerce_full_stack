...
import AdminCategoryFrom from './AdminCategoryFrom';
...
import AdminDeleteCategoryFrom from './AdminDeleteCategoryFrom';

const AdminViewCategoryListPage = () => {
    useEffect(() => {
        fetchData()
    }, []);
    ...
    const fetchData = () => {
        publicRequest.get('/type?type=Category')
            .then(res => {
...
export default AdminViewCategoryListPage