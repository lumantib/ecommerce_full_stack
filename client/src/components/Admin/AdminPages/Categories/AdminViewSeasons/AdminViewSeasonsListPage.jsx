...
import AdminDeleteSeasonsFrom from './AdminDeleteSeasonsFrom';
import AdminSeasonsFrom from './AdminSeasonsFrom';
import { columns } from './columns';
import identifiers from './identifiers';

const AdminViewSeasonsListPage = () => {
    useEffect(() => {
        fetchData()
    }, []);
    ...
    const fetchData = () => {
        publicRequest.get('/type?type=Seasons')
            .then(res => {
...
export default AdminViewSeasonsListPage