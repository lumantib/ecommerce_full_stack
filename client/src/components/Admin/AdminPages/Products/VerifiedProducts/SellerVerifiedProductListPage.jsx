...
import SellerVerifiedProductFrom from './SellerVerifiedProductFrom';
...
const SellerVerifiedProductListPage = () => {
    useEffect(() => {
        fetchData()
    }, []);
...
export default SellerVerifiedProductListPage